...
#ifdef QT_DEBUG
    db.setDatabaseName(QStringLiteral("q_media_test"));
#else
    db.setDatabaseName(QStringLiteral("q_media"));
#endif
    db.setUserName(QStringLiteral("szachara"));
    db.setPassword(QStringLiteral("99delfinu*"));
